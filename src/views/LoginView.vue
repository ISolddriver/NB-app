<template>
  <div class="login-container">
    <div class="user-layout">
      ...
      <!-- <img :src="img1" alt="" style="width: 300px; height: 150px" />
      <img :src="img2" alt="" style="width: 50px; height: 50px" /> -->
    </div>
  </div>
</template>
...
import { handleLogin, getVerifyImage } from '@/apis/login'
...
const img1 = ref('http://59.110.143.217/och-api/captcha/v1/getSrcImage')
const img2 = ref('http://59.110.143.217/och-api/captcha/v1/getCutImage')
onMounted(async () => {
